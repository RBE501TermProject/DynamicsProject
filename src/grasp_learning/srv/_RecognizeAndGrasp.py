"""autogenerated by genpy from grasp_learning/RecognizeAndGraspRequest.msg. Do not edit."""
import sys
...
class RecognizeAndGraspRequest(genpy.Message):
  _md5sum = "e3fa230f12e153918bea2d9239a36612"
  _type = "grasp_learning/RecognizeAndGraspRequest"
...
"""
  __slots__ = ['cloud','numAttempts']
  _slot_types = ['sensor_msgs/PointCloud','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecognizeAndGraspRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_b.pack(self.numAttempts))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.numAttempts,) = _struct_b.unpack(str[start:end])
      return self
...
"""autogenerated by genpy from grasp_learning/RecognizeAndGraspResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class RecognizeAndGraspResponse(genpy.Message):
  _md5sum = "358e233cde0c8a8bcfea4ce193f8fc15"
  _type = "grasp_learning/RecognizeAndGraspResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecognizeAndGraspResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
_struct_I = genpy.struct_I
_struct_B = struct.Struct("<B")
class RecognizeAndGrasp(object):
  _type          = 'grasp_learning/RecognizeAndGrasp'
  _md5sum = '54a122d57dbfaff98c40aab7cc83cff8'
  _request_class  = RecognizeAndGraspRequest
  _response_class = RecognizeAndGraspResponse
